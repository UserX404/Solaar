...
class Registers(IntEnum):
    ...
    MX_MAX_DEVICES = 0x00
    MX_LOGON = 0x02
    # give proper name when identified
    MX_UNDEF1 = 0x285   # gives 0xE700A9DE61000700040BB30006000000
    MX_UNDEF2 = 0x286   # gives 0xC6009360610007000007B00006000000
    MX_UNDEF3 = 0x287   # gives 0x00000000000000000400000000000000
    MX_UNDEF4 = 0x288   # gives 0x04383239310000000000000000000000
    MX_UNDEF5 = 0x289   # gives 0x890200
